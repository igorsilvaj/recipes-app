...
describe('Testes do componente SearchBar na rota "/meals"', () => {
  beforeEach(() => {
    ...
    const btnEnableSearch = screen.getByTestId('search-top-btn');
    expect(btnEnableSearch).toBeVisible();
    userEvent.click(btnEnableSearch);
  });
  it('Deve ser possivel buscar por ingrediente', () => {
  ...
  it('Deve ser possivel buscar por name', () => {
    const inputSearch = screen.getByRole('textbox');
    expect(inputSearch).toBeInTheDocument();
  ...
  it('Deve ser possivel buscar por first letter', () => {
    const inputSearch = screen.getByRole('textbox');
    expect(inputSearch).toBeInTheDocument();
  ...
  it('Deve disparar um alert caso seja buscado por first letter com mais de um caractere', () => {
    const inputSearch = screen.getByRole('textbox');
    expect(inputSearch).toBeInTheDocument();
    userEvent.type(inputSearch, 'lemon');
    const lblFirstLetter = screen.getByText(/first letter/i);
